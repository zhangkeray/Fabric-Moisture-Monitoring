<template>
  <div class="fluid mt-5">
    ...
    <v-row justify="center" align="center">
      <v-col cols="11">
        <v-card>
          <v-card-title class="py-0"> <h6>資訊</h6> </v-card-title>
          <v-row>
            <v-col
              v-for="value in ['目前沾濕面積: 0%', '已乾面積: 100%', '耗時: 35MIN', '每分鐘平均面積差值: 15%']"
              :key="value"
              cols="12"
              md="3"
            >
              <div
                rounded
                class="ma-4 text-center secondary text-no-wrap"
                v-text="`${value}`"
              ></div>
            </v-col>
          </v-row>
      ...
      <v-col cols="5">
        <v-row>
          <v-col cols="12">
            <v-card class="">
              <v-card-title class="py-0"> <h6>顯示</h6> </v-card-title>
              <v-responsive :aspect-ratio="4 / 3">
                <div class="frame">
                  <img id="image" src="mockImg/1-200x100.png" />
                </div>
              </v-responsive>
            </v-card>
          </v-col>
      ...
      <v-col cols="6">
        <v-row>
          <v-col cols="2">
            <v-card justify="center" align="center" class="mr-6">
              <v-card-title class="py-0"> <h6>快照選擇</h6> </v-card-title>
              <div class="carousel-wrapper px-0">
                <client-only>
                  <slick :options="slickOptions">
                    <!-- <div v-for="item in temperature" :key="item.mins"> -->
                    <div
                      v-for="item in temperature"
                      :key="item.mins"
                      class="img-wrapper"
                    >
                      <img :src="`mockImg/./${item.mins}-200x100.png`" />
                      <div class="subtitle">
                        TIME:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{
                          item.mins
                        }}MIN<br />TEMP:&nbsp;&nbsp;{{ item.temp }}℃
                      </div>
                    </div>
                    <!-- </div> -->
                  </slick>
          ...
          <v-col cols="8">
            <v-card
              ...
              style="right: 24px"
            >
              <v-card-title class="py-0"> <h6>濕度變化比對</h6> </v-card-title>
          ...
          <!-- <v-col cols="2">
            <v-card justify="center" align="center" height="34.3em">
              <v-card-title class="py-0"> <h6>紀錄</h6> </v-card-title>
              <div class="subtitle">原沾濕面積: 100%</div>
              <br />
              <div class="subtitle">目前沾濕面積: 0%</div>
              <br />
              <div class="subtitle">比較面積差值:<br />17%</div>
              <br />
              <div class="subtitle">最大面積差值:<br />20%</div>
              <br />
              <div class="subtitle">最小面積差值:<br />8%</div>
              <br />
              <div class="subtitle">平均面積差值:<br />15%</div>
            </v-card>
          </v-col> -->

          <v-col cols="6">
            <v-card justify="center" align="center" style="margin-right: 24px">
              <v-card-title class="py-0"> <h6>統計</h6> </v-card-title>
              <donut-chart-1 />
            </v-card>
          </v-col>
          ...
          <v-col cols="2">
            ...
            >
              ...
              <div class="subtitle">目前沾濕面積: 0%</div>
              <br />
              <div class="subtitle">比較面積差值: 17%</div>
              <br />
              <div class="subtitle">最大面積差值: 20%</div>
              <br />
              <div class="subtitle">最小面積差值: 8%</div>
              <br />
              <div class="subtitle">平均面積差值: 15%</div>
              <br />
            </v-card>
          </v-col>
          ...
          <v-col cols="4">
            <v-card
              justify="center"
              align="center"
              style="right: 24px; margin-right: 24px"
            >
              <v-card-title class="py-0">
                <h6 class="ngg">表面溫度</h6>
              </v-card-title>
              <v-card-text class="pb-0">
                100T
                <br />
                ROOM TEMP: 21±1℃ RH65±5% DISTANCE: 50±1CM
              </v-card-text>
              <v-simple-table fixed-header height="362px" class="mx-3 pb-3">
                <template v-slot:default>
                  <thead>
                    <tr>
                      <th class="text-center">TIME (MIN)</th>
                      <th class="text-center" style="padding-right: 40px">
                        TEMP (℃)
                      </th>
                    </tr>
                  </thead>
                  <tbody>
                    <tr v-for="item in temperature" :key="item.mins">
                      <td class="text-center">{{ item.mins }}</td>
                      <td class="text-center" style="padding-right: 40px">
                        {{ item.temp }}
                      </td>
                    </tr>
                  </tbody>
      ...
      <!-- <v-col cols="2">
        <v-card>
          ...
          <v-simple-table fixed-header height="44.5em" class="mx-3 pb-3">
            <template v-slot:default>
              <thead>
                <tr>
                  <th class="text-center">TIME (MIN)</th>
...
import RealTimeLineChart2 from '../components/index/RealTimeChart/RealTimeLineChart2.vue';
